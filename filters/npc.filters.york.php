...
class npcFiltersYork extends npcFilters {
    ...
    public static $origins = array(
        "белая"                                     => 7,
        "<font color='orange'>оранжевая</font>"     => 23,
        "<font color='green'>зеленая</font>"     => 12,
        "<font color='#00ffff'>голубая</font>"    => 18,
        "<font color='blue'>синяя</font>"       => 32,
        "<font color='#ff00ff'>фиолетовая</font>"    => 9,
        "<font color='black'>черная</font>"     => 1
    );
    ...
    {
        self::$age = function() {
            return roll3d6() + roll3d6() + roll2d6() + roll3d6() + roll3d6() + roll3d6();
        };
